---
description: Reverse-engineer any website — spawns investigation, analyst, and editor agents to produce a teardown report.
argument-hint: <site> [--redact] [--resume] [--note "..."] [--investigator "model effort"] [--analyst "model effort"] [--editor "model effort"]
